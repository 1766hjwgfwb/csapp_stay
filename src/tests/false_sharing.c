...
void false_sharing_run() {
    ...
    // false sharing
    // page0 and page1 are false sharing
    param_t p1 = {
...
int main() {
    ...
    //true_shareing和false_shareing耗费的时间一致
    //false_shareing发生了伪共享,触发了MESI协议
    //true_shareing的线程是不安全的,存在对同一地址的竞争访问
    //no_shareing因为地址空间距离大,不存在竞争访问,没有发生MESI协议
